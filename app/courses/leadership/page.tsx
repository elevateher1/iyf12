...
export default function LeadershipCoursePage() {
  return (
    <div className="container py-10">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Leadership Training</h1>
        <p className="text-muted-foreground">
          Develop core leadership skills based on biblical principles and servant leadership
        </p>
      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">15 video lessons</span>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Leadership Development Director</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">Schedule</h4>
                    <p className="text-sm text-muted-foreground">Fridays, 5:00 PM - 7:00 PM</p>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">Prerequisites</h4>
                    <p className="text-sm text-muted-foreground">
                      Basic understanding of biblical principles and completion of Mind Education I
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  "Biblical Leadership Examples.docx",
                  "Team Building Exercises.pdf",
                  "Communication Workshop Materials.pdf",
                  "Leadership Assessment Tools.xlsx",
                ].map((resource, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 border rounded-lg"
