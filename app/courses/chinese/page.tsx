...
export default function ChineseCoursePage() {
  return (
    <div className="container py-10">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Chinese Language</h1>
        <p className="text-muted-foreground">
          Learn Mandarin Chinese and explore Chinese culture
        </p>
      </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">Prof. Wei Chen</p>
                        <p className="text-sm text-muted-foreground">Chinese Language Expert</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">Schedule</h4>
                    <p className="text-sm text-muted-foreground">Tuesdays & Thursdays, 3:00 PM - 5:00 PM</p>
                  </div>
                  <div>
        ...
        <TabsContent value="resources">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  "Character Writing Guide.pdf",
                  "Pinyin Reference Chart.pdf",
                  "Common Phrases List.pdf",
                  "Tone Practice Exercises.pdf",
                  "Cultural Notes.pdf",
                ].map((resource, index) => (
                  <div
                    key={index}
